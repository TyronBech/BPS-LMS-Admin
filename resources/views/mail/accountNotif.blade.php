              ...
              <td class="content font">
                ...
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" class="panel"
                  ...
                  <tr>
                    ...
                    <td class="panel-td" style="font-weight:600; color:#0f172a;">{{ $password }}</td>
                  </tr>
                </table>
                ...
                <table role="presentation" cellpadding="0" cellspacing="0" class="btn"
                  ...
                  <tr>
                    <td align="left">
                      <!--[if mso]>
                        <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" href="{{ $msg['cta_url'] }}" style="height:44px; v-text-anchor:middle; width:220px;" arcsize="10%" strokecolor="#1e293b" fillcolor="#1e293b">
                          <w:anchorlock/>
