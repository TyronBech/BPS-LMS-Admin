...
<head>
  <meta charset="UTF-8">
  <title>{{ $msg['subject'] ?? 'Role Update' }}</title>
            ...
            <tr>
              <td class="content font">
                ...
                <p class="muted" style="margin:0 0 12px;">
                  {{ $msg['intro'] ?? 'Your role has been updated.' }}
                </p>
                <p class="muted" style="margin:0 0 20px;">
                  {{ $msg['instruction'] ?? 'Please sign in to review the changes.' }}
                </p>
                ...
                <table role="presentation" cellpadding="0" cellspacing="0" class="btn" style="margin:8px 0 18px;">
                  <tr>
                    <td align="left">
                      ...
                      <![endif]-->
                      <!--[if !mso]><!-- -->
                        <a href="{{ $msg['cta_url'] ?? '#' }}">{{ $msg['cta_label'] ?? 'Sign in' }}</a>
                      <!--<![endif]-->
                    </td>
                  </tr>
                </table>
