...
<head>
  <meta charset="UTF-8">
  <title>Profile Update Verification - {{ config('app.name') }}</title>
...
<body>
  ...
  <div style="display:none; overflow:hidden; line-height:1px; opacity:0; max-height:0; max-width:0;">
    Your profile update verification code for {{ config('app.name') }}
  </div>
              ...
              <td class="content font">
                ...
                <div class="alert-info">
                  ...
                  <p style="margin:8px 0 0; color:#1e40af; font-size:14px;">
                    You have requested to update your profile information. To confirm these changes, please use the verification code below.
                  </p>
                </div>
                ...
                <div class="alert-warning">
                  ...
                  <p style="margin:8px 0 0; color:#92400e; font-size:14px;">
                    If you did not request this change, please <strong>ignore this email</strong> and change your password immediately.
                  </p>
                </div>
                ...
                <table role="presentation" cellpadding="0" cellspacing="0" class="btn"
                  ...
                  <tr>
                    <td align="center">
                      <!--[if mso]>
                        <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" href="{{ url('/') }}" style="height:44px; v-text-anchor:middle; width:220px;" arcsize="10%" strokecolor="#1e293b" fillcolor="#1e293b">
                          <w:anchorlock/>
