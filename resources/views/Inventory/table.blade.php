  ...
  <table id="inventory-record" class="table-fixed m-4 bg-white dark:bg-gray-800">
    ...
    <tbody class="text-center">
      ...
      <tr>
        ...
        <td class="mt-1">
          <button type="button" class="text-white bg-red-500 hover:bg-red-600 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 focus:outline-none dark:focus:ring-red-800" onclick="removeRow(this)">Delete</button>
        </td>
      </tr>
      @empty
      <tr>
