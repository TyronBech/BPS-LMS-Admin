...
<div class="container mx-auto px-4 sm:px-6 lg:px-8">
  ...
  <div class="w-full p-6 bg-white border border-gray-200 rounded-lg dark:bg-gray-800 dark:border-gray-700 shadow-md">
    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-4">
      <h5 class="text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Add Announcement</h5>
    ...
    <form action="{{ route('maintenance.library-website.store-announcement') }}" method="POST" enctype="multipart/form-data" class="max-w-4xl mx-auto">
      @csrf
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
        ...
        <div>
          ...
          <input type="text" id="category" name="category" value="{{ old('category', 'Notice') }}" required
            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-400 focus:border-primary-400 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
        ...
        <div>
          <label for="image" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
            Image <span class="text-xs text-gray-500">(Max 5MB: jpeg, png, jpg, gif, webp)</span>
          </label>
      ...
      <div class="flex justify-end mt-6 gap-4">
        ...
        <button type="submit" class="text-white bg-primary-500 hover:bg-primary-400 focus:ring-4 focus:ring-primary-400 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-primary-400 dark:hover:bg-primary-500 focus:outline-none dark:focus:ring-primary-500">Create Announcement</button>
      </div>
    </form>
  </div>
</div>
