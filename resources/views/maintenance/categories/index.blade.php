...
<div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
  ...
  <div class="w-full p-4 sm:p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-4">
      ...
      <button data-modal-target="add-categories-modal" data-modal-toggle="add-categories-modal" class="w-full sm:w-auto mt-4 sm:mt-0 inline-flex items-center px-4 py-2 text-sm font-medium text-center text-white bg-primary-700 rounded-lg hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Add New Category</button>
      @endcan
    </div>
      ...
      <form action="{{ route('maintenance.store-category') }}" method="POST">
        ...
        <div class="p-4 md:p-5 space-y-4">
          ...
          <div>
            ...
            <input type="text" id="legend" name="legend" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white" placeholder="e.g., FIL" value="{{ old('legend') }}" required>
            @error('legend')
