...
<div class="flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow-sm md:flex-row md:max-w-2xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
  @if($book->cover_image)
  ...
  @elseif($cover)
  <img class="object-cover border w-full rounded h-96 md:h-auto md:w-48 mx-4" src="{{ $cover }}" alt="Book Image">
  @else
