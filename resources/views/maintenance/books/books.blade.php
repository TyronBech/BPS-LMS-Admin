  ...
  <div class="flex justify-between">
    ...
    <div class="flex flex-row">
      ...
      <div class="flex items-center">
        <form action="{{ route('maintenance.search-category') }}" method="GET" class="flex items-center mb-2 mx-2">
          @csrf
          <label for="category" class="block text-sm font-medium text-gray-900 dark:text-white"></label>
          <select id="category" name="category" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg py-2 focus:ring-blue-500 focus:border-blue-500 block w-full dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" onchange="this.form.submit()">
        ...
        <form action="{{ route('maintenance.export-barcode') }}" method="GET">
          @csrf
          <button type="submit" title="Export Barcode" name="category" value="{{ $category }}" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-3 py-1.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
