  ...
  <div class="flex justify-between">
    ...
    <div class="flex flex-row">
      <form action="{{ route('maintenance.show-books') }}" method="GET" class="flex items-center mb-2">
        ...
        <button type="submit" title="Export Barcode" name="barcodeBtn" id="exportBarcode" value="barcode" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-3 py-1.5 me-2 mb-2 mt-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
    ...
    <form action="{{ route('maintenance.create-book') }}" method="GET">
      @csrf
      <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2 me-2 my-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Add new book</button>
    </form>
    @endcan
  </div>
