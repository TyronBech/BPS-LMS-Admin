...
<div class="container mx-auto px-4 sm:px-6 lg:px-8">
  <h1 class="text-3xl text-center font-bold text-gray-800 dark:text-white mt-8 mb-6">Student Information</h1>
    ...
    <div class="flex flex-col items-center">
      ...
      <div class="w-full text-left space-y-3 text-sm md:text-base">
        <div class="flex justify-between border-b border-gray-200 dark:border-gray-700 py-2">
          <span class="font-semibold text-gray-800 dark:text-gray-300">Student Number:</span>
          <span class="text-gray-600 dark:text-gray-400">{{ $student->students->id_number }}</span>
        </div>
        <div class="flex justify-between border-b border-gray-200 dark:border-gray-700 py-2">
