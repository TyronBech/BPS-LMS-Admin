...
<div class="container mx-auto px-4 sm:px-6 lg:px-8">
  ...
  <div class="max-w-md mx-auto bg-white border border-gray-200 rounded-lg dark:bg-gray-800 dark:border-gray-700 p-6 shadow-md">
    <div class="flex flex-col items-center">
      ...
      <img class="rounded-full w-32 h-32 md:w-40 md:h-40 object-cover object-top mb-4 shadow-md" src="data:{{ $mimeType }};base64, {{ $employee->profile_image }}" alt="Employee Image">
      @else
      <img class="hidden rounded-full w-32 h-32 md:w-40 md:h-40 object-cover object-top mb-4 shadow-md dark:block" src="{{ asset('img/User-dark.png') }}" alt="Employee Image">
      <img class="rounded-full w-32 h-32 md:w-40 md:h-40 object-cover object-top mb-4 shadow-md dark:hidden" src="{{ asset('img/User-light.png') }}" alt="Employee Image">
      @endif
