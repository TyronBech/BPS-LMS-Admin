<header class="sticky top-0 z-50">
  <nav class="bg-bpsBlue border-gray-200 dark:bg-bpsBlue min-h-36 pt-5">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto">
      ...
      <div class="hidden w-full lg:block lg:w-auto pt-4" id="navbar-dropdown">
        <ul class="flex flex-col font-medium p-4 lg:p-0 mt-4 mx-8 mb-4 border border-gray-100 rounded-lg bg-bpsBlue lg:space-x-8 rtl:space-x-reverse lg:flex-row lg:mt-0 lg:border-0 lg:bg-bpsBlue dark:bg-bpsBlue">
          <li>
            <a href="#" class="block py-2 px-3 text-white bg-bpsBlue rounded hover:underline lg:bg-transparent lg:text-white lg:p-0" aria-current="page">Services</a>
          </li>
          <li>
