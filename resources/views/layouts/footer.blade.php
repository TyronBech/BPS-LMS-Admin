      ...
      <div class="grid grid-cols-2 gap-6 sm:gap-6 sm:grid-cols-3 flex-1">
        <div>
          ...
          <ul class="text-gray-500 dark:text-gray-400 font-medium">
            ...
            <li>
              <a href="{{ config('app.e_library_url') }}" target="_blank" rel="noopener noreferrer" class="hover:underline skip-loader">E-Library</a>
            </li>
          </ul>
        </div>
        <div>
          ...
          <ul class="text-gray-500 dark:text-gray-400 font-medium">
            ...
            <li>
              @if(!empty($settings->social_links['youtube']))
