      ...
      <table class="min-w-full table-auto bg-white dark:bg-gray-800">
        ...
        <tbody class="text-left">
          ...
          <tr>
            ...
            <td class="px-2 py-2"><input type="text" name="books[{{ $itemIndex }}][authors]" value="{{ $item['authors'] ?? '' }}" class="p-2 border-0 w-full bg-white dark:bg-gray-800 focus:border-b-2 hover:border-b-2 min-w-[200px]"></td>
            ...
            <td class="px-2 py-2"><input type="text" name="books[{{ $itemIndex }}][edition]" value="{{ $item['edition'] ?? '' }}" class="p-2 border-0 w-full bg-white dark:bg-gray-800 focus:border-b-2 hover:border-b-2 min-w-[100px]"></td>
