...
<div class="container mx-auto p-4 mt-4 border bg-white shadow border-gray-200 rounded-lg dark:bg-gray-800 dark:border-gray-600">
  ...
  <div class="grid gap-5 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 mt-3">
    ...
    <div class="flex flex-col w-full p-6 bg-white border-2 border-gray-300 rounded-lg shadow dark:bg-gray-700 dark:border-gray-500">
      ...
      <hr class="mb-2 border-gray-600 dark:border-gray-500">
      <ul class="font-normal overflow-y-auto h-36 text-gray-700 dark:text-gray-400">
      ...
      <ul class="font-normal overflow-y-auto h-28 text-gray-700 dark:text-gray-400">
  ...
  <div class="relative p-4 w-full max-w-md max-h-full">
    <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
      ...
      <div class="p-4 md:p-5 text-center">
        ...
        <form action="{{ route('maintenance.roles-and-permissions.delete-role') }}" method="POST" class="flex items-center justify-center">
          @csrf
          @method('DELETE')
          <button data-modal-hide="popup-modal" type="submit" id="deleteRole" name="deleteRole" class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center">
            Yes, I'm sure
          </button>
