...
<div class="w-full p-6 bg-white border border-gray-200 rounded-lg shadow  dark:bg-gray-900 dark:border-gray-600">
  <div class="flex justify-between">
    <h5 class="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Add Role</h5>
  ...
  <form action="{{ route('maintenance.roles-and-permissions.store-role') }}" class="max-w-2xl mx-auto" method="POST">
    @csrf
