...
<head>
  ...
  <title>404 • Shelf Not Found | BPS LMS</title>
...
<body>
  <main class="wrap" role="main" aria-labelledby="page-title">
    <section class="card">
      ...
      <h1 id="page-title">404 — Shelf not found</h1>
      <p class="lede">
        The book you’re looking for isn’t on this shelf. It may have been moved, renamed, or never existed.
      </p>
      ...
      <p class="hint">Error code: 404 Not Found</p>
      <footer aria-hidden="true">If you think this is a mistake, please contact support.</footer>
    </section>

    <section class="scene" aria-label="Bookshelves with a hanging 404 sign">
