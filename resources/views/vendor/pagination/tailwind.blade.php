                            ...
                            @foreach ($element as $page => $url)
                                @if ($page == $paginator->currentPage())
                                    <span aria-current="page">
                                        <span class="z-10 relative inline-flex items-center px-4 py-2 -ml-px text-sm font-medium text-gray-900 bg-white border-2 border-blue-500 cursor-default leading-5 dark:bg-gray-800 dark:border-blue-700">{{ $page }}</span>
                                    </span>
                                @else
