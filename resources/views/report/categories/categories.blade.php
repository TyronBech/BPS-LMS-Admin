...
<div class="container mx-auto px-4">
  ...
  <form action="{{ route('report.summary-update') }}" method="POST">
    ...
    <div class="fixed z-50 bottom-10 left-10">
      <button type="submit" class="flex items-center text-white bg-primary-500 hover:bg-primary-400 focus:ring-4 focus:outline-none focus:ring-primary-400 dark:bg-primary-400 dark:hover:bg-primary-500 dark:focus:ring-primary-500 font-medium rounded-lg text-sm px-5 py-2.5 text-center shadow-lg">
