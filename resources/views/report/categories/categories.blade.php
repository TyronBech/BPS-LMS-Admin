...
<div class="container mx-auto px-4">
  ...
  <form action="{{ route('report.summary-update') }}" method="POST">
    ...
    <div class="fixed z-50 bottom-10 left-10">
      <button type="submit" class="flex items-center text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center shadow-lg">
