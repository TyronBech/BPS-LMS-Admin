...
<div class="container mx-auto px-4">
  ...
  <form action="{{ route('report.accession-list-search') }}" method="POST" class="auto-search-form">
    @csrf
    <div class="flex flex-col lg:flex-row lg:items-end lg:justify-center gap-3 mb-4">
      ...
      <div class="flex flex-col sm:flex-row gap-2 w-full lg:w-auto">
        ...
        <button type="button" data-clear-url="{{ route('report.accession-list') }}" class="btn-clear-filters bg-white hover:bg-gray-100 text-gray-900 border border-gray-300 font-bold py-2.5 px-4 rounded whitespace-nowrap transition-colors dark:bg-gray-800 dark:hover:bg-gray-700 dark:text-gray-300 dark:border-gray-600 text-sm w-full sm:w-auto" title="Clear Filters">Clear</button>
