  ...
  <form action="{{ route('report.audit-trail-search') }}" method="POST" class="auto-search-form">
    ...
    <div class="flex flex-col md:flex-row md:flex-wrap md:items-end md:justify-center gap-4 mb-4">
      ...
      <div class="flex flex-col w-full md:w-auto md:flex-1 md:max-w-[180px]">
        <label for="types" class="block text-xs font-medium mb-1 text-gray-500 dark:text-gray-400">Action Type</label>
      ...
      {{-- Table Type Select --}}
      <div class="flex flex-col w-full md:w-auto md:flex-1 md:max-w-[180px]">
        <label for="tableType" class="block text-xs font-medium mb-1 text-gray-500 dark:text-gray-400">Table Name</label>
