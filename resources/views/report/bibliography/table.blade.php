<div id="tabular" class="container mx-auto mt-2 mb-4">
  <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md">
    <div class="p-4">
      <h2 class="text-center mb-4 font-semibold text-2xl dark:text-white">Bibliography of Material Collections</h2>
      <form method="GET" class="flex items-center">
        ...
        <input type="hidden" name="author" value="{{ old('author', request('author')) }}">
        <input type="hidden" name="category" value="{{ old('category', request('category')) }}">
        <input type="hidden" name="copyright_year" value="{{ old('copyright_year', request('copyright_year')) }}">
