...
<div class="container mx-auto max-w-[95%] mt-4 mb-4 px-4">
  <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-4 border border-gray-200 dark:border-gray-700">
    <h2 class="text-center mb-1 font-semibold text-2xl dark:text-white">{{ \App\Helpers\ReportHelper::getFormattedHeaderSuffix('Graph Data for Online Research', request('start_date'), request('end_date')) }}</h2>
