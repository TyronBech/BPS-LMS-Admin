<div id="summary-card" class="container mx-auto max-w-[95%] mt-4 mb-4 px-4">
  <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-4 border border-gray-200 dark:border-gray-700">
    ...
    <div class="mt-4 border-t border-gray-100 dark:border-gray-700 pt-3 flex justify-center">
      <form action="{{ route('report.computer-use-search') }}" method="POST" id="summary-filter-form" class="flex flex-wrap items-center justify-center gap-4">
        @csrf
...
<script type="module">
  $(document).ready(function() {
    ...
    $(document).on('submit', '#summary-filter-form', function(e) {
      ...
      const mainUserType = $('#user_type').val() || 'students';
