...
<div class="container mx-auto px-4">
  ...
  <form action="{{ route('report.penalties-search') }}" method="POST">
    @csrf
    <div class="flex flex-col md:flex-row md:flex-wrap md:items-end md:justify-center gap-4 mb-4">
      ...
      <div class="flex items-center w-full md:w-auto">
        <label for="search" class="block text-sm/6 font-medium mr-2">Name</label>
        <input type="text" name="search" id="search" placeholder="Juan" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" value="<?php echo $search; ?>">
      </div>
