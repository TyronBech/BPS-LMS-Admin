...
class PenaltiesController extends Controller
{
    ...
    private function exportExcel(Collection $data, array $summary, ?string $reportingPeriod = null)
    {
        ...
        $sheet->getStyle('A8:I8')->getFont()->setBold(false);
        $sheet->getStyle('A8:I8')->getFont()->setSize(10);
        $sheet->getStyle('A8:I8')->getAlignment()->setHorizontal('left');
        $sheet->getStyle('A8:I8')->getAlignment()->setVertical('left');
        ...
        $sheet->setCellValue('B9', 'Accession');
        $sheet->setCellValue('C9', 'Book');
        $sheet->setCellValue('D9', 'Borrowed Date');
        $sheet->setCellValue('E9', 'Due Date');
        $sheet->setCellValue('F9', 'Returned Date');
        $sheet->setCellValue('G9', 'Violation');
