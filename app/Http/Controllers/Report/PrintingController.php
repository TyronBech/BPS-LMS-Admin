...
class PrintingController extends Controller
{
    ...
    private function generatePDF(Collection $data)
    {
        ...
        $items = [
            'title'         => ReportHelper::getFormattedHeaderSuffix('Printing & Photocopy Report', request('start'), request('end'), $data, 'printed_at'),
            ...
            'schoolYear'    => ReportHelper::getSchoolYear(request('start'), request('end'), $data, 'printed_at')
        ];
        $options = new Options();
    ...
    private function exportExcel(Collection $data)
    {
        ...
        $sheet->setCellValue('A6', ReportHelper::getFormattedHeaderSuffix('Printing & Photocopy Report', request('start'), request('end'), $data, 'printed_at'));
